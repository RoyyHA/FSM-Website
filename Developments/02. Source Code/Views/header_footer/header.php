            ...
            <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                ...
                <nav class="grid__item" id="AccessibleNav">
                    ...
                    <ul id="siteNav" class="site-nav medium center hidearrow">
                        ...
                        <li class="lvl1 parent megamenu"><a href="?act=compare">Compare<i class="anm anm-angle-down-l"></i></a></li>
                        <li class="lvl1 parent megamenu"><a href="?act=wishlist">Wishlist<i class="anm anm-angle-down-l"></i></a></li>
                        <li class="lvl1 parent megamenu"><a href="?act=about">About <i class="anm anm-angle-down-l"></i></a></li>
                        <li class="lvl1 parent megamenu"><a href="?act=contact">Contact <i class="anm anm-angle-down-l"></i></a></li>
                        <li class="lvl1"><a href="?act=shop"><b>Buy Now!</b> <i class="anm anm-angle-down-l"></i></a></li>
                    </ul>
                </nav>
                <!--End Desktop Menu-->
            </div>
